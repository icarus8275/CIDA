/** Shared course → standard code map for seed & verify scripts. */
export const COURSE_STANDARD_CODES: Record<number, string[]> = {
...
export function idesNumberFromCourseName(name: string): number | null {
